...
export default function RegisterPages() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-200 px-4 py-3 flex justify-center">
      <button
        type="button"
        onClick={() => navigate("/")}
        title="Volver a Home"
        className="absolute left-5 top-5 z-20 inline-flex h-10 items-center justify-center gap-2 rounded-xl border border-red-900/10 bg-white/80 px-3.5 text-sm font-black text-red-900 shadow-lg shadow-slate-300/40 backdrop-blur transition hover:-translate-y-0.5 hover:bg-red-900 hover:text-white hover:shadow-xl"
      >
        <svg
          viewBox="0 0 24 24"
          fill="none"
      ...
      <div className="relative z-10 w-full max-w-5xl overflow-hidden rounded-[1.25rem] border border-white/70 bg-white/95 shadow-2xl backdrop-blur-xl">
        ...
        <div className="px-5 py-5 sm:px-7 lg:px-9">
          <div className="mb-5 flex flex-col items-center text-center">
            <span className="mb-2 inline-flex rounded-full border border-red-900/10 bg-red-900/5 px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.24em] text-red-900">
            ...
            <p className="mt-1.5 text-xs font-bold text-red-900">
              * Campos requeridos
            </p>
          </div>

          <div className="mb-5">
            <label className="mb-3 block text-xs font-black uppercase tracking-[0.2em] text-slate-500">
              Tipo de cuenta *
            </label>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-3 shadow-xl sm:p-4">
            {accountType === "" && (
              <div className="flex min-h-[170px] flex-col items-center justify-center rounded-2xl border border-dashed border-gray-300 bg-slate-50/70 text-center">
