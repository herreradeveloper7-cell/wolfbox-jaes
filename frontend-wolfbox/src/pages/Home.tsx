  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 relative overflow-hidden">
      ...
      <div className='flex flex-col sm:flex-row gap-6 mt-8 z-10'>
        ...
        <button onClick={() => navigate('/consulta-hawb')} className='bg-red-900 text-white py-2 px-6 sm:py-3 sm:px-8 text-base sm:text-lg lg:text-xl rounded-2xl cursor-pointer shadow-md hover:bg-red-950 transition duration-300 transform hover:scale-105 hover:shadow-lg"'>
          Consultar guia
        </button>
      </div>
