...
const Home: React.FC = () => {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-200 px-4 py-3 text-slate-900 sm:px-6">
      <div
      ...
      <section className="relative z-10 mx-auto flex min-h-[calc(100vh-1.5rem)] w-full max-w-4xl flex-col justify-center">
        <div className="grid overflow-hidden rounded-[1.25rem] border border-white/75 bg-white/90 shadow-2xl shadow-slate-400/40 backdrop-blur-xl lg:grid-cols-[1fr_0.9fr]">
          <div className="relative min-h-[360px] overflow-hidden bg-gradient-to-br from-red-950 via-red-900 to-slate-950 px-5 py-5 text-white sm:px-6 lg:px-7">
              ...
              <div className="flex justify-center">
                <div className="flex flex-col items-center text-center">
                  <img
                    src={logo}
                    alt="Jaes Cargo"
                    className="h-28 w-28 rounded-[1.5rem] bg-white/95 object-contain p-3 shadow-2xl shadow-slate-950/45 ring-2 ring-white/85 sm:h-36 sm:w-36 lg:h-40 lg:w-40"
                  />
                </div>
              </div>

              <div className="max-w-xl py-3">
                <p className="mb-2 inline-flex border border-white/15 bg-white/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.22em] text-white/75 rounded-xl">
                  Plataforma logistica
                </p>
                <h1 className="text-2xl font-black leading-tight sm:text-3xl">
                  Operaciones y casilleros en un solo centro.
                </h1>
                <p className="mt-3 max-w-lg text-sm font-medium leading-5 text-white/72">
          ...
          <div className="flex min-h-[360px] flex-col justify-between px-5 py-5 sm:px-6 lg:px-7">
            <div>
              <div className="mb-4">
                <p className="text-[10px] font-black uppercase tracking-[0.22em] text-red-900">
                  Centro de acceso
                </p>
                <h2 className="mt-1.5 text-xl font-black text-gray-700">
                  Selecciona el modulo
                </h2>
                <p className="mt-1.5 max-w-md text-sm font-medium leading-5 text-slate-500">
              ...
              <div className="space-y-2">
                {actions.map((action) => (
                  <button
                    ...
                    className={`group flex min-h-16 w-full items-center justify-between gap-3 rounded-xl border px-4 py-2.5 text-left shadow-sm transition duration-300 hover:-translate-y-0.5 hover:shadow-xl cursor-pointer ${
                      action.tone === "primary"
                  ...
                  >
                    ...
                    <span
                      className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-xl transition group-hover:translate-x-1 ${
                        action.tone === "primary"
                    ...
                    >
                      <img
                        src={arrowRight}
                        alt=""
                        className={`h-5 w-5 ${action.tone === "primary" ? "brightness-0 saturate-100 invert-[12%] sepia-[61%] hue-rotate-[344deg] contrast-[103%]" : ""}`}
                      />
                    </span>
                  </button>
                ))}
